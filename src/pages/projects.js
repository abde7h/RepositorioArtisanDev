  ...
  return (
    <article className="w-full flex flex-col items-center justify-center rounded-2xl border border-solid border-dark bg-light p-6 relative dark:bg-dark dark:border-light xs:p-4">
      ...
      <Link
        href={link}
        target="_blank"
        className="w-full hover:cursor-pointer overflow-hidden rounded-lg"
      >
        <FramerImage
          src={img}
          alt={title}
      ...
      <div className="w-full flex flex-col items-start justify-between mt-4">
        ...
        <Link
          href={link}
          target="_blank"
          className="hover:underline hover:cursor-pointer underline-offset-2"
        >
          <h2 className="my-2 w-full text-left text-3xl font-bold hover:cursor-pointer lg:text-2xl">
            {title}
          </h2>
        </Link>
...
const projects = () => {
  return (
    <>
      <Head>
        <title>ArtisanDev | Proyectos</title>
        <meta
          name="description"
          content="Explora una colección de proyectos de desarrollo web creativos y soluciones únicas que he creado. Descubre cómo puedo ayudarte a llevar a cabo tu visión en línea."
        />
      </Head>
